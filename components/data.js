...
let namesIcons = [
    {
        name: 'react',
        tag: <i key={'react'} className="fab fa-react fa-xs" title='React.js'></i>
    },
    {
        name: 'js',
        tag: < i key={'js'} className="fab fa-js fa-xs" title='JavaScript'></i >
    },
    {
        name: 'css',
        tag: <i key={'css'} className="fab fa-css3-alt fa-xs" title='CSS 3'></i>
    },
    {
        name: 'html',
        tag: <i key={'html5'} className="fab fa-html5 fa-xs" title='HTML 5'></i>
    }
]